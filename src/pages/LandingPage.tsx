...
export const LandingPage: React.FC<LandingPageProps> = ({ onNavigate, onLoginClick, onRegisterClick }) => {
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA] text-[#191C1D] flex flex-col justify-between selection:bg-indigo-500 selection:text-white">
      {/* Top Navbar */}
      <header className="sticky top-0 z-40 bg-white/90 backdrop-blur-md border-b border-[#E5E7EB]">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          >
            <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-[#3525CD] to-[#712AE2] flex items-center justify-center shadow-lg shadow-indigo-500/25 group-hover:scale-105 transition-transform">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-[#464555]">
            <a href="#hero" className="text-[#3525CD] font-semibold hover:text-[#3525CD] transition-colors">Home</a>
            ...
            <button onClick={handleCandidateStart} className="hover:text-[#3525CD] transition-colors">For Candidates</button>
            <button onClick={handleRecruiterStart} className="hover:text-[#3525CD] transition-colors">For Recruiters</button>
          </nav>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-[#3525CD] to-[#712AE2] text-white text-sm font-semibold shadow-[0_10px_20px_-5px_rgba(79,70,229,0.35)] hover:shadow-[0_15px_25px_-5px_rgba(79,70,229,0.45)] hover:opacity-95 transition-all"
            >
              Get Started
            </button>
          </div>
      ...
      <section id="hero" className="relative pt-12 pb-20 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            {/* Small pill badge */}
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-gradient-to-r from-indigo-50 to-purple-50 border border-indigo-100/80 shadow-xs">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-[#191C1D] tracking-tight leading-[1.12]">
              ...
              <span className="bg-gradient-to-r from-[#3525CD] via-[#4F46E5] to-[#712AE2] bg-clip-text text-transparent">
                AI Intelligence
              </span>
            </h1>
            ...
            <div className="flex flex-wrap items-center gap-4 pt-2">
              <button
                ...
                className="px-7 py-3.5 rounded-xl bg-gradient-to-r from-[#3525CD] to-[#712AE2] text-white text-base font-semibold shadow-[0_10px_25px_-5px_rgba(79,70,229,0.4)] hover:shadow-[0_15px_30px_-5px_rgba(79,70,229,0.5)] hover:scale-[1.02] transition-all flex items-center gap-2"
              >
          ...
          <div className="lg:col-span-5 relative">
            {/* Background Glow */}
            <div className="absolute -inset-4 bg-gradient-to-tr from-indigo-500/10 to-purple-500/10 rounded-3xl blur-2xl -z-10" />
            ...
            <div className="bg-white rounded-3xl p-6 border border-[#E5E7EB] shadow-[0_20px_50px_-10px_rgba(79,70,229,0.12)] space-y-5">
              ...
              <div className="space-y-3">
                ...
                <div className="w-full bg-indigo-50 h-2 rounded-full overflow-hidden">
                  <div className="w-[92%] h-full bg-gradient-to-r from-[#3525CD] to-[#712AE2] rounded-full" />
                </div>
                ...
                <div className="w-full bg-indigo-50 h-2 rounded-full overflow-hidden">
                  <div className="w-[88%] h-full bg-gradient-to-r from-[#3525CD] to-[#712AE2] rounded-full" />
                </div>
                ...
                <div className="w-full bg-indigo-50 h-2 rounded-full overflow-hidden">
                  <div className="w-[90%] h-full bg-gradient-to-r from-[#3525CD] to-[#712AE2] rounded-full" />
                </div>
              </div>

              {/* AI Recommendation Summary Box */}
              <div className="p-3.5 bg-gradient-to-br from-indigo-50/70 to-purple-50/70 rounded-2xl border border-indigo-100 flex items-start gap-3">
                <BrainCircuit className="w-5 h-5 text-[#712AE2] shrink-0 mt-0.5" />
                <div>
                  <div className="flex items-center gap-2">
                    <span className="text-xs font-bold text-[#3525CD] uppercase">AI Verdict: Strongly Recommended</span>
                  </div>
              ...
              <div className="pt-2 flex items-center justify-between text-xs text-[#737380]">
                ...
                <button 
                  onClick={handleRecruiterStart} 
                  className="text-[#3525CD] font-bold hover:underline flex items-center gap-1"
                >
      ...
      <section id="features" className="py-20 bg-white border-t border-b border-[#E5E7EB]">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <button onClick={handleCandidateStart} className="text-left bg-[#F8F9FA] p-6 rounded-2xl border border-[#E5E7EB] hover:border-indigo-200 hover:bg-white hover:shadow-[0_15px_30px_-5px_rgba(79,70,229,0.08)] transition-all flex flex-col justify-between group">
              <div>
                <div className="w-12 h-12 rounded-xl bg-indigo-50 border border-indigo-100 flex items-center justify-center text-[#3525CD] mb-5 group-hover:scale-110 transition-transform">
              ...
              <div className="mt-6 pt-4 border-t border-gray-200/70 text-xs font-semibold text-[#3525CD] flex items-center gap-1">
            ...
            <button onClick={handleCandidateStart} className="text-left bg-[#F8F9FA] p-6 rounded-2xl border border-[#E5E7EB] hover:border-indigo-200 hover:bg-white hover:shadow-[0_15px_30px_-5px_rgba(79,70,229,0.08)] transition-all flex flex-col justify-between group">
              <div>
                <div className="w-12 h-12 rounded-xl bg-purple-50 border border-purple-100 flex items-center justify-center text-[#712AE2] mb-5 group-hover:scale-110 transition-transform">
              ...
              <div className="mt-6 pt-4 border-t border-gray-200/70 text-xs font-semibold text-[#712AE2] flex items-center gap-1">
            ...
            <button onClick={handleCandidateStart} className="text-left bg-[#F8F9FA] p-6 rounded-2xl border border-[#E5E7EB] hover:border-indigo-200 hover:bg-white hover:shadow-[0_15px_30px_-5px_rgba(79,70,229,0.08)] transition-all flex flex-col justify-between group">
              ...
              <div className="mt-6 pt-4 border-t border-gray-200/70 text-xs font-semibold text-blue-600 flex items-center gap-1">
            ...
            <button onClick={handleRecruiterStart} className="text-left bg-[#F8F9FA] p-6 rounded-2xl border border-[#E5E7EB] hover:border-indigo-200 hover:bg-white hover:shadow-[0_15px_30px_-5px_rgba(79,70,229,0.08)] transition-all flex flex-col justify-between group">
              <div>
      ...
      <section id="how-it-works" className="py-16 bg-[#F8F9FA]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <span className="text-xs font-bold uppercase tracking-wider text-[#3525CD]">End-to-End Pipeline</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="bg-white p-5 rounded-2xl border border-[#E5E7EB] text-center">
              <span className="w-8 h-8 rounded-full bg-indigo-50 text-[#3525CD] font-bold text-sm inline-flex items-center justify-center mb-3">1</span>
            ...
            <div className="bg-white p-5 rounded-2xl border border-[#E5E7EB] text-center">
              <span className="w-8 h-8 rounded-full bg-indigo-50 text-[#3525CD] font-bold text-sm inline-flex items-center justify-center mb-3">2</span>
            ...
            <div className="bg-white p-5 rounded-2xl border border-[#E5E7EB] text-center">
              <span className="w-8 h-8 rounded-full bg-indigo-50 text-[#3525CD] font-bold text-sm inline-flex items-center justify-center mb-3">3</span>
            ...
            <div className="bg-white p-5 rounded-2xl border border-[#E5E7EB] text-center">
              <span className="w-8 h-8 rounded-full bg-indigo-50 text-[#3525CD] font-bold text-sm inline-flex items-center justify-center mb-3">4</span>
